    ...
    <main>
        ...
        <article class="contenedor">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                ...
                <label for="">Ingrese número decimal</label>
                <input class="valores" type="text" name="valor1">

                <label for="">Ingrese el número binario</label>
                ...
                if (isset($_POST['envio'])) {
                    ...
                    $binario = $_POST['valor2'];
                    $decimal = $_POST['valor1'];

                    echo "<br> Su número decimal a binario es: " . decbin($decimal) . "<br>";
                    echo "<br> El número binario a decimal es: " . bindec($binario) . "\n";
