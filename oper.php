        ...
        <article class="contenedor">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                ...
                if (isset($_POST['envio'])) {
                    ...
                    echo "<p>La suma es: {$total}</p>" . "<br>" . "<br>";
                    ...
                    echo "El total de la resta es: $total" . "<br>";
                    ...
                    echo "El total de la multiplicacion es: $total" . "<br>";
                    ...
                    echo "El total de la division es: $total" . "<br>";
                    ...
                    echo "El total del modulo es: $total" . "<br>";
                }
                ?>
