    ...
    <main>
        ...
        <article class="contenedor">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                <h1>Calcular cantidad de cifras</h1>
                ...
                if (isset($_POST['envio'])) {
                    ...
                    if ($a >= 0 and $a <= 9) {
                        echo "Tiene 1 cifra" . "<br>";
                    }
                    if ($a >= 10 and $a <= 99) {
                        echo "Tiene 2 cifras" . "<br>";
                    }
                    if ($a >= 100 and $a <= 999) {
                        echo "Tiene 3 cifras" . "<br>";
                    }
                    if ($a >= 1000 and $a <= 9999) {
                        echo "Tiene 4 cifras" . "<br>";
                    }
                    if ($a >= 10000 and $a <= 99999) {
                        echo "Tiene 5 cifras" . "<br>";
                    }
                    if ($a >= 100000 and $a <= 999999) {
                        echo "Tiene 6 cifras" . "<br>";
                    }
                    if ($a >= 1000000) {
                        echo "Este numero supera al 1000000" . "<br>";
                    }
                }
                ?>
